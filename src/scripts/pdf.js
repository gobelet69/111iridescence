...
function renderSettings(inputs) {
    ...
    if (app.activeTool === "organize") {
        ...
        grp.innerHTML = `<button onclick="rotateSelected(90)" class="px-3 py-1.5 bg-white rounded shadow-sm text-sm font-semibold hover:text-indigo-500">↻ 90°</button><button onclick="deleteSelected()" class="px-3 py-1.5 bg-white rounded shadow-sm text-sm font-semibold hover:text-red-600 text-red-500">🗑 Delete</button>`;
